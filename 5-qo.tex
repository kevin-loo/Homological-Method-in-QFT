...
Different regularizations are related by the homotopy RG (HRG) flow:
...
\draw [color={rgb, 255:red, 144; green, 19; blue, 254 },draw opacity=1 ] (78.71,53.37) .. controls (106.69,33.96) and (129.65,42.23) .. (147.47,52.37) ;
\draw [shift={(149.95,53.81)}, rotate = 210.62] [fill={rgb, 255:red, 144; green, 19; blue, 254 },draw opacity=0][line width=0.08] (10.72,-5.15) -- (0,0) -- (10.72,5.15) -- (7.12,0) -- cycle    ;
\draw [shift={(75.98,55.34)}, rotate = 323.13] [fill={rgb, 255:red, 144; green, 19; blue, 254 },draw opacity=0][line width=0.08] (10.72,-5.15) -- (0,0) -- (10.72,5.15) -- (7.12,0) -- cycle    ;
...
% Text Node
\draw (60.62,58.71) node [anchor=north west][inner sep=0.75pt]    {\textcolor{blue}{$I[r_{1}]$}};
% Text Node
\draw (131.67,58.33) node [anchor=north west][inner sep=0.75pt]    {\textcolor{blue}{$I[r_{2}]$}};
% Text Node
\draw (95.53,27.36) node [anchor=north west][inner sep=0.75pt]   [align=left] {\textcolor{rgb, 255:red, 144; green, 19; blue, 254 }{HRG}};
\end{tikzpicture}
\eea


\subsection*{Heat kernel regularization}\label{subsec:heat}
...
To cancel the divergences, one can find the \emph{counter-terms}, $I^\eps\in \hbar \sO_{loc}(\cE)\llb \hbar\rrb$, which are $\vep$-dependent and singular as $\vep\to 0$ such that
\bea \lim_{\vep\to 0} \exp{\lb \hbar\p_{P_\vep^L}\rb} e^{\lb I_0+I^\eps\rb/\hbar}\coloneqq e^{I[L]^{naive}/\hbar}\eea exists. 
...
\eea
In other words, the family $\lcb I[L]^{naive}\rcb_{L>0}$ satisfies the homotopy RG (HRG) flow.
\bea
\tikzset{every picture/.style={line width=0.75pt}} %set default line width to 0.75pt
\begin{tikzpicture}[x=0.75pt,y=0.75pt,yscale=-1,xscale=1]
%uncomment if require: \path (0,300); %set diagram left start at 0, and has height of 300
