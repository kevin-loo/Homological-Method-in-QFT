...
\begin{itemize}
    ...
    \item $W[n]$ denotes the $\bZ$-graded vector space with a degree shift by $n$ such that
    $W[n]_m \coloneqq W_{n+m}$.
...
\bea \boxed{L_\infty \text{-relations for } \lcb \ell_n\rcb_{n\geq 1}\ \LRA\ \delta^2=0}\ .\eea
