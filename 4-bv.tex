...
Let us form 
\bea \cO(\cE)\coloneqq \prod_{n\geq 0}\sym^n(\cE^\vee).\eea
...
\bea \lcb -,-\rcb: \cO_{\text{loc}}(\cE)\times \cO_{\text{loc}}(\cE)\to \cO_{\text{loc}}(\cE).\eea
\bea
    \begin{fmffile}{fdd}
    \begin{tabular}{c}
...
\bea
\begin{tikzcd}
\cO(V)\llb \hbar\rrb \ar[r, "e^{\hbar\p_P}"] \ar[d,"Q+\hbar \Delta_0"]
& \cO(V)\llb \hbar\rrb \ar[d,"Q+\hbar \Delta_P"] \\
\cO(V)\llb \hbar\rrb \ar[r, "e^{\hbar\p_P}"]
& \cO(V)\llb \hbar\rrb
\end{tikzcd}
\eea
which implies that
\bea \text{QME for } (\cO(V),Q,\Delta_0) \xrightarrow{e^{\hbar \p_P}}
\text{QME for } (\cO(V),Q,\Delta_P),\eea
...
\noindent{\em Costello's approach}: use the elliptic regularity:
\bea H^\blt(\text{distribution}, Q)=H^\blt(\text{smooth}, Q).\eea 
...
\bea \lb\cO(\cE)\llb \hbar\rrb,Q+\hbar\Delta_r\rb \xrightarrow{\exp{\lb \hbar \p_{P^{r'}_r}\rb}}
