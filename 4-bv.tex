...
\bea \boxed{QI_0+\hf \lcb I_0,I_0\rcb=0}\ .\eea
...
\bea \boxed{QI+ \hbar \Delta I+\hf \lcb I,I\rcb =0}\ .\eea
...
\bea
\begin{tikzcd}
\sO(V)[[ \hbar]] \ar[r, "\exp{(\hbar\p_P)}"] \ar[d, swap, "Q+\hbar \Delta_0"]
& \sO(V)[[ \hbar]] \ar[d,"Q+\hbar \Delta_P"] \\
\sO(V)[[ \hbar]] \ar[r, "\exp{(\hbar\p_P)}"]
& \sO(V)[[ \hbar]]
\end{tikzcd}
\eea
which implies that
\bea \text{QME for } (\sO(V),Q,\Delta_0) \xrightarrow{\exp{(\hbar\p_P)}}
...
\bea \lb\sO(\cE)[[ \hbar]],Q+\hbar\Delta_r\rb \xrightarrow{\exp{\lb \hbar \p_{P^{r'}_r}\rb}}
\lb\sO(\cE)[[ \hbar]],Q+\hbar\Delta_{r'}\rb.\eea

\begin{defn}[Costello \cite{costello2011renormalization}]
